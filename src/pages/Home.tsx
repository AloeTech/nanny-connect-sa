  ...
  const features = [
    {
      ...
      description: "All nannies undergo background checks and training verification"
    },
    {
      icon: Video,
      title: "Nanny Academy",
    ...
    },
    {
      ...
      description: "Secure platform to connect families with trusted caregivers"
    },
    {
      icon: Star,
      title: "Quality Assured",
      description: "Only approved profiles with completed training and checks"
    }
  ];
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Criminal background verification and credit checks for all nannies
                </p>
              </CardContent>
            </Card>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              <Badge variant="outline" className="text-amber-800 border-amber-300 px-4 py-2">
                Report concerns to: safety@nannyplacement.co.za
              </Badge>
            </div>
          </div>
        </div>
